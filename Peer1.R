...
# open PDF
pdf(file="loansData.pdf", height=11, width=8.5)
...
smoothScatter(loansData$FICO.Range.floor, loansData$Interest.Rate,
              xlab="FICO Score",
              ylab="Interest Rate (%)",
              main="Figure 1. Interest Rate v. FICO Score")
...
plot(xFICO, loansData$Interest.Rate,
     ...
     xlab="FICO Score",
     ylab="Interest Rate (%)",
     main="Figure 2. Amount of the Loan Requested")
...
plot(xFICO, loansData$Interest.Rate,
     ...
     xlab="FICO Score",
     ylab="Interest Rate (%)",
     main="Figure 3. Amount of the Loan Actually Funded")
legend(780, 25,
       legend=c("$0-5k", "$5-10k", "$10-20k", "$20-35k"),
       col=c("black", "red", "green", "blue"),
       pch=19, cex=0.5)
...
lengthFactor <- 
  plot(xFICO, loansData$Interest.Rate,
       ...
       xlab="FICO Score",
       ylab="Interest Rate (%)",
       main="Figure 4. Length of the Loan" )
legend(780, 25,
